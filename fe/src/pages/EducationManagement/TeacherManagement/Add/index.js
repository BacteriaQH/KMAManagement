...
import { Col, FormCheck, FormControl, FormGroup, FormLabel, FormSelect, Row } from 'react-bootstrap';
        ...
        <>
            ...
            <Row className="mb-3">
                <FormGroup as={Col} controlId="formStudentId">
                    ...
                    <FormControl type="text" placeholder="Nhập mã giảng viên" />
                </FormGroup>
            ...
            <Row>
                ...
                <FormGroup as={Col} controlId="formPhoneNumber">
                    ...
                    <FormControl type="text" placeholder="Nhập số điện thoại" />
                </FormGroup>
            </Row>
            <Row>
                <FormGroup as={Col}>
